...
**Lecture overlap:** almost none. W4 s5 and s9 describe generating a new random key pair for every payment received (the 'independent key generation' model this chapter contrasts with HD wallets); W4 s12 wallets in the ecosystem; W2 s58-60, s97-98 threshold signatures (the same t-of-n idea as SLIP39 recovery codes, but a different mechanism). Everything about seeds, BIP39 words, BIP32 derivation, xpub/xprv, hardened keys, and BIP44 paths is book-only, and because this is a reading quiz it is still fair game.
...
## Diagrams: recovery code -> seed -> HD tree (BIP39 + BIP32 + BIP44)
...
_Source: Mastering Bitcoin, 3rd edition, chapter 5 (github.com/bitcoinbook/bitcoinbook, `develop` branch). Lecture citations `W4 s18` = week-4 slide 18. Full lecture-vs-book analysis: the Cross-Reference page._
