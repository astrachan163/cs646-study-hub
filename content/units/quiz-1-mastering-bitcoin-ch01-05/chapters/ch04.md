...
**Lecture overlap:** most of week 2. W2 s2 three basic algorithms (one-way hash, digital signature, ECC); s4-9 one-way hash properties and two collision types; s10-16 SHA family, birthday attack; s18-27 RSA ('read it'), 'encryption is not used directly in bitcoin', signature properties; s28 important schemes and post-quantum; s41-42, s61-62 discrete log and why elliptic curves; s63-77 curves over finite fields, base point; s79 secp256k1 'Koblitz curve' with (E, G, p, n); s80 Q = dG; s82 ECDSA malleability; s83-85 EC-Schnorr / MuSig 'used by Bitcoin'. W4 s7-9 'Account # = Hash(Kp)'; W4 s27-31 scriptSig/scriptPubKey and the P2PKH script bytes. Not covered in class: base58/base58check and prefixes, compressed keys, P2SH/BIP16, bech32/bech32m, WIF, vanity and paper wallets.
...
## Diagrams: private key -> public key -> address, and address family tree
...
_Source: Mastering Bitcoin, 3rd edition, chapter 4 (github.com/bitcoinbook/bitcoinbook, `develop` branch). Lecture citations `W4 s18` = week-4 slide 18. Full lecture-vs-book analysis: the Cross-Reference page._
